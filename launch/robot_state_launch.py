...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('x', default_value='-0.2', description='X position of camera relative to robot base'),
        DeclareLaunchArgument('y', default_value='0', description='Y position of camera relative to robot base'),
        DeclareLaunchArgument('z', default_value='0.43', description='Z position of camera relative to robot base'),
